...
namespace Nebula.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult SocialInfo()
        {
            var userId = User.Identity.GetUserId();
        ...
        [HttpPost]
        public JsonResult SocialInfo(User user)
        {
            try
            {
                var userId = User.Identity.GetUserId();
                ...
                {
                    var originUser = _db.Users.Find(userId);
                    originUser.FirstName = user.FirstName;
                    originUser.LastName = user.LastName;
                    originUser.PhoneNumber = user.PhoneNumber;
                    //originUser.School = user.School;
                    //originUser.Address = user.Address;
                    //originUser.SocialText = user.SocialText;
