...
$(document).ready(function () { 
    $('.burger-menu-video').on('click', function () {
        $('.course-div').toggleClass('course-show');
    });
    $('.burger-menu-header').on('click', function () {
        $('.list-show').toggleClass('list-toggle');
    });
    $('.burger-menu-header').on('click', function () {
        $('.enter').toggleClass('list-toggle');
    });
    $('.burger-menu-header').on('click', function () {
        $('.registration').toggleClass('list-toggle');
    });
    $('.enter').on('click', function () {
        $('.container-main-slider').toggleClass('opac');
    }); 
});
     ...
     chart = Highcharts.chart('chart-div', {
        ...
        plotOptions: {           
           ...
           series: {
              ...
              marker: {
                  symbol: 'url(' + U + 'Content/assetsNew/img/chart-point.svg)',
                  width: 21,
                  height: 21,                  
                  states: {
                      hover: {
